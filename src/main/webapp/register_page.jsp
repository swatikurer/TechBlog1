		...
		<div class="container ">
			...
			<div class="col-md-6 offset-md-3">
				<div class="card">
					...
					<div class="card-body">
						<form id="registrationForm" action="RegisterServlets"
							method="POST">
							...
							<div class="form-group">
								<textarea name="about" class="form-control" cols="30" rows="10"
									placeholder="enter something about urself"></textarea>
							</div>
							...
							<button id="submit-btn" type="submit"
								class="btn btn-primary btn-center">Submit</button>
